...
function title() {
console.clear()
console.log(chalk.bold.green(figlet.textSync('ModzyBot-MD', {
font: 'Standard',
...
console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Kiki ]')}\n\n${chalk.red('MidzyBot-Md')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@kiki_notrobot')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 896-5343-0712')}\n${chalk.red('Donate')} : ${chalk.white('089653430712 ( Dana/Pulsa )')}\n`))
}
...
browser: ['MidzyBot-Md','Safari','1.0.0'],
auth: state
})
title()
store.bind(Manik.ev)
...
Manik.sendMessage(`6289653430712@s.whatsapp.net`, {text: '*Report Bot:*'+ callerId+ 'Called Bot'})
await sleep(8000)
